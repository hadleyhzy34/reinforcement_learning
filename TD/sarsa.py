...
Q = np.zeros((env.observation_space.n, env.action_space.n))
Q_pre = np.copy(Q) # to check convergence when training
...
plt.plot(list(range(5000)),sarsa_reward_record,label='sarsa learning')
plt.legend()
plt.show()

plt.plot(list(range(5000)),error_record,label='q learning')
plt.plot(list(range(5000)),sarsa_error_record, label='sarsa learning')
plt.legend()
plt.show()
